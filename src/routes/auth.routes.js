...
router.post('/session/admin', authMiddleware.loginAdminAccount, authController.loginAdminAccount);
...
router.get('/perms', authMiddleware.isAuthentified, authController.getPermissions);
